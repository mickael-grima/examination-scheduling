...
\begin{frame}{Constraints}
  	\begin{itemize} 
	    ...
	    \ba
	   	(1) & \sum_{\mbox{\small{ rooms $k$}}} x_{i,k,l} &&\leq y_{i,l} \cdot M &&\forall \mbox{\small{ exams $i$, }}  \forall \mbox{\small{ periods $l$}}  \\
	    \uncover<2->{
...
\begin{frame}{Constraints}
	\begin{itemize}                     
  		\item Each exam is planned in exactly one period:
		\ba
		(3) & \sum_{\mbox{\small{ periods $l$}}} y_{i,l} &&= 1 &&\forall \mbox{ exams $i$ } \\
		\uncover<2->{
...
\begin{frame}{Constraints}
    \begin{itemize}
        ...
        \ba
        (6) & \sum_{\substack{\mbox{\footnotesize{ exams $j$,}} \\  \mbox{\footnotesize{$i$ conflicts with $j$}} }}y_{j,l} &&\leq (1-y_{i,l}) \cdot M &&\forall \mbox{\footnotesize{ exams $i$, }} \forall \mbox{\footnotesize{ periods $l$ }}
        \ea
    \end{itemize}
\end{frame}
