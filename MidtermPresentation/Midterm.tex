...
\begin{document}
        ...
        \section{ILP Formulation}
         ...
         \begin{frame}{There are enough seats}
         	\begin{enumerate} 
         		...
         		\ba
         		\sum_{\substack{\forall \mbox{\small{ periods $l$, }} \\ \forall \mbox{\small{ rooms $k$ }}}} c_k * x_{i,k,l} \geq s_i \;\;\;\;\;\;\;\;\; \forall \mbox{\small{ exams $i$}}
         		\ea
         ...
         \begin{frame}{One exam at a time}
         	\begin{enumerate}
         		...
         		\ba
         		\sum_{ \forall \mbox{\small{ exams $i$ }}} x_{i,k,l} \leq 1 \;\;\;\;\;\;\;\;\;  \forall \mbox{\small{ rooms $k$}}, \forall \mbox{\small{ periods $l$ }}
         		\ea
         	\end{enumerate}
         \end{frame}
        ...
        \begin{frame}{No conflicts}
        	\begin{enumerate}
        		...
        		\ba
        		\sum_{\substack{\forall \mbox{\small{ exams $j$:}} \\  \mbox{\small{$i$,$j$ have a conflict}} }}y_{j,l}  \leq (1-y_{i,l})*M \;\;\;\ \forall \mbox{\small{ exams $i$, }}  \forall \mbox{\small{ periods $l$ }}
        		\ea
        	\end{enumerate}
        \end{frame}
