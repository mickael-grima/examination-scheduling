...
\begin{frame}{Constraints}
  	\begin{itemize} 
	    ...
	    \pause
	    \ba
	   	(1) & \sum_{\mbox{\small{ rooms $k$}}} x_{i,k,l} &&\leq y_{i,l} \cdot M &&\forall \mbox{\small{ exams $i$, }}  \forall \mbox{\small{ periods $l$}}  \\[4mm]
	    \uncover<3->{
	    (2) & \sum_{\mbox{\small{ rooms $k$}}} x_{i,k,l} &&\geq y_{i,l} &&\forall \mbox{\small{ exams $i$, }}  \forall \mbox{\small{ periods $l$}}
	    }
   		\ea
   	\end{itemize}
\end{frame}
...
\begin{frame}{Constraints}
	\begin{itemize}                     
  		...
  		\pause
		\ba
		(3) & \sum_{\mbox{\small{ periods $l$}}} y_{i,l} &&= 1 &&\forall \mbox{ exams $i$ } \\[4mm]
		\uncover<3->{
		\text{c.f. }(2) & \sum_{\mbox{\small{ rooms $k$}}} x_{i,k,l}  &&\geq y_{i,l} &&\forall \mbox{ exams $i$, } \forall \mbox{\small{ periods $l$}}
		}
		\ea
 	\end{itemize}
\end{frame}
...
\begin{frame}{Constraints}
    \begin{itemize} 
        ...
        \pause
        \ba
        (4) & \sum_{\substack{\mbox{\small{ periods $l$, }} \\ \mbox{\small{ rooms $k$ }}}} c_k \cdot x_{i,k,l} &&\geq s_i &&\forall \mbox{\small{ exams $i$}}
        \ea
...
\begin{frame}{Constraints}
    \begin{itemize}    
        ...
        \pause
        \ba
        (5) & \sum_{\mbox{\small{ exams $i$ }}} x_{i,k,l} &&\leq 1 &&\forall \mbox{\small{ rooms $k$}}, \forall \mbox{\small{ periods $l$ }}
        \ea
    \end{itemize}
\end{frame}
...
\begin{frame}{Constraints}
    \begin{itemize}
        ...
        \pause
        \ba
        (6) & \sum_{\substack{\mbox{\footnotesize{ exams $j$,}} \\  \mbox{\footnotesize{$j$ conflicts with $i$}} }}y_{j,l} &&\leq (1-y_{i,l}) \cdot M &&\forall \mbox{\footnotesize{ exams $i$, }} \forall \mbox{\footnotesize{ periods $l$ }}
        \ea
    \end{itemize}
\end{frame}
...
\begin{frame}{Objective function}
	\begin{itemize}
        ...
        \ba
        \min & \sum_{\substack{\mbox{\small{ exams $i$,}} \\ \mbox{\small{ rooms $k$,}} \\ \mbox{\small{ periods $l$}}}} x_{i,k,l} 
        \ea
	\end{itemize}
\end{frame}
...
\begin{frame}{Objective function}
	\begin{itemize}
		...
		\ba
		\max \sum_{\substack{\mbox{\small{ exams $i,j$}} \\ \mbox{\small{$i>j$}} }}   d_{i,j}
		\ea
...
\begin{frame}{Objective function}
    \begin{itemize}	
	    ...
	    \ba
	    \min \sum_{\substack{\mbox{\small{ exams $i$,}} \\ \mbox{\small{ rooms $k$,}} \\ \mbox{\small{ periods $l$}}}} x_{i,k,l} \ - \ \gamma \cdot \sum_{\substack{\mbox{\small{ exams $i,j$}} \\ \mbox{\small{$i>j$}} }}   d_{i,j}
	    \ea
	\end{itemize}
\end{frame}
